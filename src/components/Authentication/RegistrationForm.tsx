...
export default function RegistrationForm() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center  p-4 bg-gradient-to-l from-[white] to-[#e8f7eb]">
      <div className="w-full max-w-6xl overflow-hidden rounded-[2rem] bg-white shadow-[0_0_40px_rgba(0,0,0,0.2)]">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="relative w-[70%]">
            <div className="bg-gradient-to-br from-[#f0f9f0] to-[#e6f7e6] p-10  skew-x-12 w-full h-full absolute ml-16"></div>
