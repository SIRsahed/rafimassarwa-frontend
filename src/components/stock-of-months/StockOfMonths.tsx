...
export default function StockOfMonths() {
  ...
  const currentItems = stocksData.slice(startIndex, endIndex)
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-2 sm:p-4 md:p-6 container mx-auto border mt-10">
      <h2 className="text-xl sm:text-2xl font-medium mb-4">Stock Of Month</h2>
          ...
          <tbody className="divide-y divide-gray-200">
            {currentItems.map((stock) => (
              <tr key={stock.id} className="hover:bg-gray-50">
                ...
                <td className="px-2 sm:px-4 py-3 sm:py-4 text-red-500 text-xs sm:text-sm font-medium">-7.24%</td>
