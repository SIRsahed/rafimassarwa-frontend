...
export default function EPBanner() {
  return (
    <section className="pt-16 sm:pt-20 md:pt-28 lg:pt-36 bg-[#EAF6EC] overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8">
          <div className="md:col-span-1 lg:col-span-3">
            <Image
              ...
              width={500}
              height={500}
              className="w-24 h-12 sm:w-28 sm:h-20 lg:w-32 lg:h-24 object-cover mb-6 sm:mb-8 lg:mb-10"
            />
            ...
            <p className="max-w-[435px] text-sm sm:text-base lg:text-[16px] font-medium text-[#595959] pb-8 md:pb-0">
